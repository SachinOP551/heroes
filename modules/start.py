...
# Welcome images
WELCOME_IMAGES = [
    "https://ibb.co/8LfcCwnT",
    "https://ibb.co/5W8YYKwn",
    "https://ibb.co/Tqt7JV58",
    "https://ibb.co/FQR1smR",
    "https://ibb.co/bR5cWXpL",
    "https://ibb.co/PzbShjht"
]
...
async def start_command(client: Client, message: Message):
    ...
    welcome_text = (
        f"🌟 ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ᴛʜᴇ sᴜᴘᴇʀ ʜᴇʀᴏᴇs ᴄᴏʟʟᴇᴄᴛ ᴜɴɪᴠᴇʀsᴇ {user.first_name}!\n\n"
        "ʏᴏᴜʀ ᴊᴏᴜʀɴᴇʏ ɪɴ ᴛʜᴇ ᴍᴜʟᴛɪᴠᴇʀsᴇ ʙᴇɢɪɴs ʜᴇʀᴇ\n\n"
        "✨ ғᴇᴀᴛᴜʀᴇs:\n"
        "┣ ᴄᴏʟʟᴇᴄᴛ ʀᴀʀᴇ sᴜᴘᴇʀ ʜᴇʀᴏᴇs\n"
        "┣ ᴛʀᴀᴅᴇ ᴡɪᴛʜ ᴏᴛʜᴇʀ ᴄᴏʟʟᴇᴄᴛᴏʀs\n"
        "┣ ᴄᴏᴍᴘᴇᴛᴇ ɪɴ ʟᴇᴀᴅᴇʀʙᴏᴀʀᴅs\n"
        "┣ ᴇᴀʀɴ ᴛᴏᴋᴇɴs & ʀᴇᴡᴀʀᴅs\n"
        "┗ sʜᴏᴡᴄᴀsᴇ ʏᴏᴜʀ ᴄᴏʟʟᴇᴄᴛɪᴏɴ\n\n"
        "🎮 ǫᴜɪᴄᴋ sᴛᴀʀᴛ:\n"
        "┣ /daily -  ᴄʟᴀɪᴍ ᴅᴀɪʟʏ ʀᴇᴡᴀʀᴅs\n"
        "┣ /collect - ʙᴇɢɪɴ ᴄᴏʟʟᴇᴄᴛɪɴɢ\n"
        "┣ /claim - ᴄʟᴀɪᴍ ᴀ ᴅᴀɪʟʏ ғʀᴇᴇ sᴜᴘᴇʀ ʜᴇʀᴏ\n"
        "ʀᴇᴀᴅʏ ᴛᴏ ᴀssᴇᴍʙʟᴇ ʏᴏᴜʀ ᴛᴇᴀᴍ ᴏғ sᴜᴘᴇʀ ʜᴇʀᴏᴇs?"
    )
...
async def help_callback(client: Client, callback_query: CallbackQuery):
    ...
    help_text = (
        "🦸‍♂️ ᴍᴄᴜ ᴄᴏʟʟᴇᴄᴛ ᴄᴏᴍᴍᴀɴᴅs 🦸‍♀️\n\n"
        "📱 ʙᴀsɪᴄ ᴄᴏᴍᴍᴀɴᴅs\n"
        "┣ /start - ʀᴇsᴛᴀʀᴛ ᴛʜᴇ ʙᴏᴛ\n"
        "┣ /bal - ᴄʜᴇᴄᴋ ʏᴏᴜʀ ᴛᴏᴋᴇɴs\n"
        "┣ /claim - ᴄʟᴀɪᴍ ᴀ ᴅᴀɪʟʏ ғʀᴇᴇ ᴄʜᴀʀᴀᴄᴛᴇʀ\n"
        "┗ /daily - ᴄʟᴀɪᴍ ᴅᴀɪʟʏ ʀᴇᴡᴀʀᴅs\n\n"
        "🎮 ᴄᴏʟʟᴇᴄᴛɪᴏɴ\n"
        "┣ /collect - ᴄᴏʟʟᴇᴄᴛ ᴄʜᴀʀᴀᴄᴛᴇʀs\n"
        "┣ /mycollection - ᴠɪᴇᴡ ʏᴏᴜʀ ᴄᴏʟʟᴇᴄᴛɪᴏɴ\n"
        "┣ /search - sᴇᴀʀᴄʜ ᴄʜᴀʀᴀᴄᴛᴇʀs\n"
        "┣ /check - ᴄʜᴇᴄᴋ ᴄʜᴀʀᴀᴄᴛᴇʀ ɪɴғᴏ\n"
        "┗ /srarity - sᴇᴀʀᴄʜ ʙʏ ʀᴀʀɪᴛʏ\n\n"
        "🔄 ᴛʀᴀᴅɪɴɢ\n"
        "┣ /trade - ᴛʀᴀᴅᴇ ᴄʜᴀʀᴀᴄᴛᴇʀs\n"
        "┣ /gift - ɢɪғᴛ ᴄʜᴀʀᴀᴄᴛᴇʀs\n"
        "┗ /propose - ᴘʀᴏᴘᴏsᴇ ᴄʜᴀʀᴀᴄᴛᴇʀs\n\n"
        "📊 ʀᴀɴᴋɪɴɢs\n"
...
async def back_callback(client: Client, callback_query: CallbackQuery):
    ...
    random_image = random.choice(WELCOME_IMAGES)
    welcome_text = (
        f"ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ᴛʜᴇ sᴜᴘᴇʀ ʜᴇʀᴏᴇs ᴄᴏʟʟᴇᴄᴛ ᴜɴɪᴠᴇʀsᴇ {callback_query.from_user.first_name} 🌟\n\n"
        "ᴀssᴇᴍʙʟᴇ ʏᴏᴜʀ ᴛᴇᴀᴍ ᴏғ sᴜᴘᴇʀ ʜᴇʀᴏᴇs ᴀɴᴅ ᴠɪʟʟᴀɪɴs!\n\n"
        "✨ ғᴇᴀᴛᴜʀᴇs:\n"
        "┣ ᴄᴏʟʟᴇᴄᴛ ʀᴀʀᴇ sᴜᴘᴇʀ ʜᴇʀᴏᴇs\n"
        "┣ ᴛʀᴀᴅᴇ ᴡɪᴛʜ ᴏᴛʜᴇʀ ᴄᴏʟʟᴇᴄᴛᴏʀs\n"
        "┣ ᴄᴏᴍᴘᴇᴛᴇ ɪɴ ʟᴇᴀᴅᴇʀʙᴏᴀʀᴅs\n"
        ...
        "┣ /collect - ʙᴇɢɪɴ ᴄᴏʟʟᴇᴄᴛɪɴɢ\n"
        "┣ /claim - ᴄʟᴀɪᴍ ᴀ ᴅᴀɪʟʏ ғʀᴇᴇ sᴜᴘᴇʀ ʜᴇʀᴏ\n\n"
        "ʀᴇᴀᴅʏ ᴛᴏ sᴛᴀʀᴛ ʏᴏᴜʀ ᴄᴏʟʟᴇᴄᴛɪɴɢ ᴊᴏᴜʀɴᴇʏ?"
    )
