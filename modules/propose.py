        ...
        try:
            ...
            if is_special_user:
                ...
                if not available_rarities:
                    await message.reply_text("<b>❌ ɴᴏ ᴄʜᴀʀᴀᴄᴛᴇʀs ᴀᴠᴀɪʟᴀʙʟᴇ ғᴏʀ ᴘʀᴏᴘᴏsᴇ!</b>")
                    return
            ...
            if is_accepted:
                ...
                fail_text = (
                    "<b>❌ ʏᴏᴜʀ ᴘʀᴏᴘᴏsᴀʟ ᴡᴀs ʀᴇᴊᴇᴄᴛᴇᴅ!</b>"
                )
                try:
...
async def proposelock_command(client: Client, message: Message):
    ...
    message = "<b>🔒 ᴘʀᴏᴘᴏsᴇ ʀᴀʀɪᴛʏ ʟᴏᴄᴋs</b>\n\n"
    message += "<b>ʟᴏᴄᴋᴇᴅ ʀᴀʀɪᴛɪᴇs:</b>\n"
    if settings.get('locked_rarities'):
        for rarity in settings['locked_rarities']:
            emoji = RARITY_EMOJIS.get(rarity, "❓")
            message += f"• {emoji} {rarity}\n"
    else:
        message += "• No rarities locked\n"
