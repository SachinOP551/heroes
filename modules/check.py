    ...
    try:
        ...
        if len(args) < 2:
            await message.reply_text(
                "❌ ᴘʟᴇᴀsᴇ ᴘʀᴏᴠɪᴅᴇ ᴀ ᴄʜᴀʀᴀᴄᴛᴇʀ ɪᴅ!\n"
                "ᴜsᴀɢᴇ: /check <character_id>"
            )
            return
        ...
        try:
            ...
            await message.reply_text(
                "❌ ɪɴᴠᴀʟɪᴅ ᴄʜᴀʀᴀᴄᴛᴇʀ ɪᴅ! ᴘʟᴇᴀsᴇ ᴘʀᴏᴠɪᴅᴇ ᴀ ɴᴜᴍʙᴇʀ!"
            )
            return
        ...
        message_text = (
            ...
            f"<b>🆔 ɪᴅ:</b> `{char_id}`\n\n"
            f"<b>☘️ ɢʟᴏʙᴀʟʟʏ ᴄᴏʟʟᴇᴄᴛᴇᴅ:</b> {unique_count} ᴛɪᴍᴇs"
        )
    ...
    try:
        ...
        if not collectors:
            await callback_query.message.edit_caption(
                caption="<b>👥 ɴᴏ ᴄᴏʟʟᴇᴄᴛᴏʀs ɪɴ ᴛʜɪs ɢʀᴏᴜᴘ!</b>"
            )
            return
        ...
        collectors_text = (
            f"<b>👥 ᴄᴏʟʟᴇᴄᴛᴏʀs ɪɴ ᴛʜɪs ɢʀᴏᴜᴘ:</b>\n"
            f"<b>ᴜɴɪǫᴜᴇ:</b> {unique_count} | <b>ᴛᴏᴛᴀʟ:</b> {total_count}\n\n"
        )
...
async def top_collectors_callback(client: Client, callback_query: CallbackQuery):
    ...
    try:
        ...
        if not character:
            await callback_query.message.edit_caption(
                caption="<b>❌ ᴄʜᴀʀᴀᴄᴛᴇʀ ɴᴏᴛ ғᴏᴜɴᴅ!</b>"
            )
            return
        ...
        if not top_collectors:
            await callback_query.message.edit_caption(
                caption="<b>❌ ɴᴏ ᴄᴏʟʟᴇᴄᴛᴏʀs ғᴏᴜɴᴅ!</b>"
            )
            return
...
async def back_to_character_callback(client: Client, callback_query: CallbackQuery):
    ...
    try:
        ...
        message_text = (
            ...
            f"<b>{rarity_emoji} ʀᴀʀɪᴛʏ:</b> {rarity}\n\n"
            f"<b>🆔 ɪᴅ:</b> `{char_id}`\n\n"
            f"<b>☘️ ɢʟᴏʙᴀʟʟʏ ᴄᴏʟʟᴇᴄᴛᴇᴅ:</b> {unique_count} <b>ᴛɪᴍᴇs</b>"
        )
